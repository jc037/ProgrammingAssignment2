...
## This creates a matrix as defined by the user-input, defines a function to retrieve that matrix, and sets i to null to indicate to cacheSolve that the cache has been updated.
